...
//    }
    ...
    public void showQL(List<QLBH> list) {
        ...
        for (QLBH i : list) {
            ...
            String tenNV = i.getNhanVien().getTen();
            int maDV = i.getDichVu().getMa();
            String tenDV = i.getDichVu().getTen();
            int sl = i.getSoLuong();
    ...
    private void initComponents() {
        ...
        jPanel1.getAccessibleContext().setAccessibleName("Sắp xếp");
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (r >= 0 && r < jTable2.getRowCount()) {
            ...
            NhanVien nv = new NhanVien(ma, ten, dc, sdt);
            listNV.set(r, nv);
        } else {
    ...
    private void btnThemDV1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemDV1ActionPerformed
        ...
        try {
            ...
            sl = Integer.parseInt(jTextField12.getText());
            if (!tontai(maNV, maDV)) {
                QLBH ql = new QLBH();
                for (int i = 0; i < listNV.size(); i++) {
                    if (listNV.get(i).getMaNV() == maNV) {
                        ql.setNhanVien(listNV.get(i));
                        break;
                    }
                }
                for (int i = 0; i < listDV.size(); i++) {
                    if (listDV.get(i).getMa() == maDV) {
                        ql.setDichVu(listDV.get(i));
                        break;
                    }
                }
                ql.setSoLuong(sl);
...
//                showQL(listQL);
    ...
    private void btnTim1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTim1ActionPerformed
        ...
        for (QLBH i : listQL) {
            if (i.getNhanVien().getTen().trim().toLowerCase().contains(key) || i.getDichVu().getTen().trim().toLowerCase().contains(key)) {
                l.add(i);
            }
        }
        showQL(l);
    ...
    private void btnTinhCongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTinhCongActionPerformed
        jTextArea1.setText("Ma \t Ten \t Tien cong \n");
//        HashSet<Integer> nv = new HashSet<>();
//        HashSet<Integer> dv = new HashSet<>();
//        for (QLBH i : listQL) {
//            nv.add(i.getNhanVien().getMaNV());
//            dv.add(i.getDichVu().getMa());
//        }
//        for (Integer i : nv) {
//            double thuNhap = 0;
//            NhanVien n = new NhanVien();
//            for (QLBH qlbh : listQL) {
//                if(i==qlbh.getNhanVien().getMaNV()){
//                    n = listQL.get(i);
//                }
//            }
//            jTextArea1.append(i + "\t" + n.getTen() + "\t");
//            for (Integer k : pb) {
//                PhongBan p = getPBByMa(k);
//                for (int j = 0; j < a.size(); j++) {
//                    if (a.get(j).getMaNV() == i && a.get(j).getMaPB() == k) {
//                        thuNhap = 850000 * (2 + ((double) n.getBacLuong() / 3))
//                                * p.getHeSo()
//                                * ((double) a.get(j).getNgayLam() / 22);
//                    }
//                }
//            }
//            jTextArea1.append(thuNhap + "\n");
        Map<String, Double> tc = listQL.stream().collect(Collectors.groupingBy(
                QLBH::getMaVaTen, Collectors.summingDouble(QLBH::tinhTienCong)));
        tc.forEach((K,V)->{
    ...
    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton1ActionPerformed
        ...
        if(jRadioButton1.isSelected()){
            listQL.sort(new Comparator<QLBH>(){

                @Override
                public int compare(QLBH t, QLBH t1) {
                    String[] ht1 = t.getTenNhanVien().split("\\s+");
                    String ten1 = ht1[ht1.length-1];
                     String[] ht2 = t1.getTenNhanVien().split("\\s+");
                    String ten2 = ht2[ht2.length-1];
                    if(ten1.equalsIgnoreCase(ten2)){
                        return t.getTenNhanVien().compareToIgnoreCase(t1.getTenNhanVien());
                    }
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton2ActionPerformed
        Collections.sort(listQL, Comparator.comparing(QLBH::getTenDichVu));
        showQL(listQL);
